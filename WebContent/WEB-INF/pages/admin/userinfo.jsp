...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="form" action="${pageContext.request.contextPath }/userAction_save.action" method="post" >
				...
				<tr>
	           	...
	           	<tr><td>角色:</td>
		           	<td colspan="3" id="roleTD">
		           		<script type="text/javascript">
		           			//发送ajax请求获取所有角色数据，展示为复选框
		           			var url = "${pageContext.request.contextPath}/roleAction_list.action";
		           			$.post(url,{},function(data){
		           				for(var i=0;i<data.length;i++){
		           					var id = data[i].id;
		           					var name = data[i].name;
		           					$("#roleTD").append("<input value='"+id+"' name='roleIds' type='checkbox'>" + name);
		           				}
		           			});
		           		</script>
		           	</td>
