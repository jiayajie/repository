	                ...
	                <table cellpadding=3>
	                    <tr>
	                        ...
	                        <td><input id="txtNewPass" type="Password"
	                         data-options="required:true,validType:'length[3,6]'" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
	                        <td><input id="txtRePass" type="Password" data-options="required:true,validType:'length[3,6]'" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                </table>
                </form>
            </div>
